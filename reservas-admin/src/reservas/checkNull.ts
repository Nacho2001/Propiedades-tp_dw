...
/*
    Función para prevenir carga de valores nulos en Reservas
 */
export default 
function checkNull(reserva: ReservaDto){
    ...
    let props = Object.entries(reserva)
    // Recorre el array
    for (let index = 0; index < props.length; index++) {
        /* Declara una variable para el item. 
            Cada item es un array que contiene la clave y el valor. Ej: ['id', '2']
        */
